...
export default function Home() {
  return (
    <div className="home-container">
      {/* ===== Header: Option B (centered title + two badges) ===== */}
      ...
      <main>
        ...
        <section className="hero" aria-labelledby="hero-heading">
          <div className="hero-text">
            ...
            {/* If using React Router, replace with <Link to="/membership" className="cta-button">…</Link> */}
        ...
        <div className="info-sections">
          <section className="meetings card" aria-labelledby="meetings-heading">
            ...
            <p><span aria-hidden="true">📅 </span>Every 4th Saturday of the month</p>
            <p>
              <span aria-hidden="true">📍 </span>
              Venue: <strong>Paine College Chapel</strong>, 15th St., Augusta, GA
            </p>
            <p><span aria-hidden="true">🕒 </span>Time: 10:00 AM</p>
          </section>

          <section className="location card" aria-labelledby="office-heading">
            <h3 id="office-heading">Service Office</h3>
            <p><span aria-hidden="true">📍 </span><strong>Charlie Norwood VA Medical Center</strong>, Room GA126</p>
            ...
            <p><span aria-hidden="true">🕒 </span>Hours: Monday–Thursday, 8:00 AM–12:00 PM</p>
          </section>
        </div>
        ...
        <section className="getvabuddy-section card" aria-labelledby="buddy-heading">
          ...
          {/* Grid layout uses display: contents on the link to keep the grid cells */}
          <a
          ...
          >
            ...
            <div>
              ...
              <div className="muted">Visit Get VA Buddy for easy help navigating VA forms and benefits online.</div>
            </div>
          </a>
        </section>
